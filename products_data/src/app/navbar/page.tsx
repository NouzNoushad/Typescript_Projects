            ...
            <div className="max-w-[1200px] mx-auto px-5 xl:px-0 h-full">
                <div className="flex flex-row items-center justify-between h-full">
                    ...
                    <div className="space-x-[20px]">
                        <Link href="/home" className="uppercase text-[0.9rem] font-[500] relative before:absolute before:bottom-[-2px] before:left-0 before:h-[0.1rem] before:bg-white before:w-0 before:transition-all before:duration-300 hover:before:w-full">Home</Link>
